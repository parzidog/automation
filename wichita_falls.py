...
printRateExceptions = driver.find_element(By.XPATH, '//*[@id="reportsListWidget"]/div/div[2]/div[3]/ul/li[1]/a')
ActionChains(driver) \
    .key_down(Keys.CONTROL) \
    .key_down(Keys.SHIFT) \
...
managementSummary = driver.find_element(By.XPATH, '//*[@id="reportsListWidget"]/div/div[3]/div[2]/ul/li[8]/a')
ActionChains(driver) \
    .key_down(Keys.CONTROL) \
    .key_down(Keys.SHIFT) \
...
printManagementSummary = driver.find_element(By.XPATH, '//*[@id="iframeContents"]/div/section/div/form/div[2]/div[2]/button')
...
occupancyOverview = driver.find_element(By.XPATH, '//*[@id="reportsListWidget"]/div/div[3]/div[2]/ul/li[11]/a')
ActionChains(driver) \
    .key_down(Keys.CONTROL) \
    .key_down(Keys.SHIFT) \
...
printOccupancyOverview = driver.find_element(By.XPATH, '//*[@id="printReport"]')
fromDays.click()
