...
"}")
        ...
        self.label_title.setStyleSheet("color: rgba(255,255,255,255); padding: 3px;")
        self.label_title.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        ...
        self.label_title2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.label_title2.setObjectName("label_title2")
        self.horizontalLayout_3.addWidget(self.label_title2, 0, QtCore.Qt.AlignHCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.initial_setup.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.site3.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.site6.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.site8.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.site9.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.site7.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.site4.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.amarillo.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.wichita_falls.sizePolicy().hasHeightForWidth())
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.wichita_falls.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>WF</p></body></html>"))
